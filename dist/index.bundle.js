...
;(() => {
  ...
  const orderArray = (array) => {
    ...
    if (array[0].dueDate) { 
      orderFunc = function (lastElem, nextElem) { 
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(new Date(lastElem.dueDate), new Date(nextElem.dueDate))
      }
  ...
  const checkToday = (objDate) => {
    ...
    const objDateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(new Date(objDate), 'yyyy-MM-dd')
  ...
  const checkAllDates = () => {
    ...
    //past
    projectList.forEach(project => project.isPast = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_7__.default)(project.dueDate)))
    projectList.forEach(project => project.todoList.forEach(todo => todo.isPast = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_7__.default)(todo.dueDate))))
