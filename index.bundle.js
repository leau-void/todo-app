...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/lightFormat/index.js");
...
const logicWrapper = (() => {
  ...
  const orderArray = (array) => {
    ...
    if (array[0].dueDate) { 
      orderFunc = function (lastElem, nextElem) { 
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(lastElem.dueDate), (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.default)(nextElem.dueDate))
      }
  ...
  const init = () => {
    const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_7__.default)(new Date(), {weeks: 1}), 'yyyy-MM-dd')
